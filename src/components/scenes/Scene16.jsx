...
export default function Scene16() {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-green-50 rounded-xl shadow-md max-w-3xl mx-auto">
      ...
      <button
        ...
        className="mt-6 bg-lime-600 text-white px-4 py-2 rounded shadow hover:bg-lime-700"
      >
