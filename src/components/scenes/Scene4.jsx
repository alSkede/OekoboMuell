...
export default function Scene4() {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-orange-100 rounded-xl shadow-md max-w-3xl mx-auto">
      ...
      <button
        ...
        className="mt-6 bg-purple-500 text-white px-4 py-2 rounded shadow hover:bg-purple-600"
      >
