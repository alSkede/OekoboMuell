...
export default function Scene13() {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-slate-100 rounded-xl shadow-md max-w-3xl mx-auto">
      ...
      <button
        ...
        className="mt-6 bg-neutral-700 text-white px-4 py-2 rounded shadow hover:bg-neutral-800"
      >
