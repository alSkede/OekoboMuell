...
export default function Scene18() {
  ...
  const [showQuiz, setShowQuiz] = useState(true); // Quiz direkt sichtbar

  return (
    <div className="flex flex-col items-center p-6 bg-purple-50 rounded-xl shadow-md max-w-3xl mx-auto">
      ...
      <div className="bg-white p-4 my-4 rounded-lg border-l-4 border-purple-500 w-full max-w-xl">
        <p className="italic">🗯️ {scene.trudeSpeech}</p>
      </div>

      {showQuiz && (
        <div className="bg-white border border-gray-300 p-4 rounded w-full max-w-xl">
