...
export default function Scene6() {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-lime-100 rounded-xl shadow-md max-w-3xl mx-auto">
      ...
      <button
        ...
        className="mt-6 bg-yellow-600 text-white px-4 py-2 rounded shadow hover:bg-yellow-700"
      >
