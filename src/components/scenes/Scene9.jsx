...
export default function Scene9() {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-orange-50 rounded-xl shadow-md max-w-3xl mx-auto">
      ...
      <button
        ...
        className="mt-6 bg-rose-600 text-white px-4 py-2 rounded shadow hover:bg-rose-700"
      >
