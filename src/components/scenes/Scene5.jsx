...
export default function Scene5() {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-emerald-100 rounded-xl shadow-md max-w-3xl mx-auto">
      ...
      <button
        ...
        className="mt-6 bg-pink-600 text-white px-4 py-2 rounded shadow hover:bg-pink-700"
      >
