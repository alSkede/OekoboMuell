...
export default function Scene12() {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-zinc-100 rounded-xl shadow-md max-w-3xl mx-auto">
      ...
      <button
        ...
        className="mt-6 bg-gray-800 text-white px-4 py-2 rounded shadow hover:bg-gray-900"
      >
